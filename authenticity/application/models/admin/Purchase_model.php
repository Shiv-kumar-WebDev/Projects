...
class Purchase_model extends CI_Model
{
	...
	public function getorderproduct($id) 
	{
		...
		$this->db->where("purchased_products.purchase_id", $id);
		$this->db->join("product", "purchased_products.product_id=product.product_id");
		$this->db->join("variant", "purchased_products.purchased_variantid=variant.variant_id","left");
        $query = $this->db->get();
       // echo $this->db->last_query();
        return $query->result_array();
	}
