 <div id="page-content">        
        ...
        <div class="breadcrumbs-wrapper">
            <div class="container">
                <div class="breadcrumbs"><a href="<?php echo base_url();?>" title="Back to the home page">Home</a> <span aria-hidden="true">|</span> <span>Shop Categories </span></div>
            </div>
        </div>
        <!--End Breadcrumbs-->
        <div class="container">
                        ...
                        <div class="filters-toolbar-wrapper">
                            <div class="row">
                                <div class="col-6 col-md-6 col-lg-6 text-center filters-toolbar__item filters-toolbar__item--count d-flex justify-content-center align-items-center">
                                    <span class="filters-toolbar__product-count">Showing: <?php echo $totalpro = (count($cat_data));?> Results</span>
                                </div>
