    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="pull-right">
                <a href="<?php echo base_url("Waste_List");?>"><button type="button"  class="btn btn-danger pull-left"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</button></a>&nbsp;
            ...
            <td>
                ...
                <strong>Waste Date:</strong> <?php echo date('d/m/Y',$details[0]['waste_date']);?><br>
            </td>
            ...
            <?php } ?>
                ...
                <?php if(isset($orderproduct)){
                    ...
                    <tr>
                        ...
                        <td style="text-transform: uppercase;" class="text-center"><?php if (!empty($row['variantid'])) { echo $row['size'].' ---> '.$row['color'];  }else{
                            echo "-";
                        };?></td>
                    ...
                    <tr class="trttotal">
                        ...
                        <td>₹ <?php echo $details[0]['waste_total'];?></td>
                    </tr>
                    <?php }else{
