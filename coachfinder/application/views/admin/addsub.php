          ...
          <div class="col-md-8">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h4 class="text-center" class="card-title">ADD NEW SUBJECT</h4>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form id="contact-form" name="contact-form" action="<?php echo base_url('admin/admin/doaddsub'); ?>" method="POST">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <input type="text" id="sub_name" name="sub_name" class="form-control" placeholder="ENTER SUBJECT NAME" required>
