				...
				<?php $this->view('coach/cosidebar'); ?>
					...
					<div class="col-lg-8 col-12">
                       ...
                       <div class="contact-form-area m-top-30">
							...
							<form class="form" method="post" action="<?php echo base_url();?>co_doupdate">
								<div class="row">
									...
									<div class="col-lg-6 col-md-6 col-12">
										<div class="form-group">
											 ...
											 <?php foreach($subject as $sub){
												$st='';  
												if ($profile[0]['subject_id']==$sub['sub_id']) {
													$st='selected';
												...
												<option <?php echo $st;?> value="<?php echo $sub['sub_id'];?>"><?php echo $sub['sub_name'];?></option>
											 <?php }?>
											 </select>
										</div>
									</div>
