...
<form action="<?php echo base_url();?>Client/doadd_client" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered" >
		...
		<div class="block">
			...
			<h2> Shipping Address </h2>
				...
				<div class="form-group">
					<label class="col-sm-3 control-label" for="example-input-small"> Address </label>
					<div class="col-sm-9">
						<textarea required id="example-input-small"  name="shipping_add" class="form-control input-sm" placeholder=" "></textarea>
					</div>
				</div>
				...
				<label class="col-md-3 control-label" for="example-select"> City </label>
				<div class="col-md-9">
				<select required id="example-select2" name="shipping_city" class="select-select2 chooseshipcity" style="width: 100%;" data-placeholder=" Select State..">
				...
				<div class="form-group">
					<label class="col-sm-3 control-label"> Pin Code </label>
					<div class="col-sm-9">
						<input type="text" class="form-control" name="shipping_pin" placeholder=" " required>
					</div>
				</div>
	 	</div> 
