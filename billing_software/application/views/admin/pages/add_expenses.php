...
<label class="col-md-2 control-label" for="example-select2"> Vendor Name  </label>
<div class="col-md-4">
...
<div class="form-group">
<label class="col-md-2 control-label" for="example-datepicker"> Number </label>
<div class="col-md-1">
...
<div class="form-group">
<label class="col-md-3 control-label" for="example-datepicker">  Payment Method </label>
<div class="col-md-2">
<input type="text" class="form-control" placeholder="">
</div>

<label class="col-md-2 control-label" for="example-datepicker">  Client </label>
