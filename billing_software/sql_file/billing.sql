...
CREATE TABLE `addresses` (
  ...
  `address_type` tinyint(4) NOT NULL DEFAULT 1 COMMENT '1=>billing address, 2=> shipping address',
  `user_type` tinyint(4) NOT NULL DEFAULT 1 COMMENT '1=> client, 2=>vendor',
...
INSERT INTO `addresses` (`id`, `address`, `country`, `state`, `city`, `pincode`, `address_type`, `user_type`, `user_id`, `status`, `created`, `updated`) VALUES
(1, '10 Basai road\r\ngurgaon', '101', '5', '6335', '122123', 1, 1, 1, 1, '2021-10-24 14:41:47', '2021-10-24 14:41:47'),
(2, '10 Basai road\r\ngurgaon', '101', '5', '6336', '122123', 2, 2, 1, 1, '2021-10-24 14:41:47', '2021-10-24 14:41:47'),
(3, '10 Basai road\r\ngurgaon', '101', '5', '6337', '122001', 1, 1, 2, 1, '2021-10-24 15:06:44', '2021-10-24 15:06:44'),
(4, '10 Basai road\r\ngurgaon', '101', '6', '7342', '122001', 2, 2, 2, 1, '2021-10-24 15:06:44', '2021-10-24 15:06:44'),
(5, '10 Basai road\r\ngurgaon', '101', '6', '7328', '122009', 1, 1, 3, 1, '2021-11-02 11:41:56', '2021-11-02 11:41:56'),
(6, '10 Basai road\r\ngurgaon', '101', '5', '6336', '122123', 2, 2, 3, 1, '2021-11-02 11:41:56', '2021-11-02 11:41:56'),
(7, '10 Basai road\r\ngurgaon', '101', '6', '7328', '122009', 1, 1, 4, 1, '2021-11-02 11:42:33', '2021-11-02 11:42:33'),
(8, '10 Basai road\r\ngurgaon', '101', '5', '6336', '122123', 2, 2, 4, 1, '2021-11-02 11:42:33', '2021-11-02 11:42:33');
...
INSERT INTO `clients` (`id`, `company_name`, `contact_person`, `phone`, `email`, `gst_treatment`, `gstin`, `pan`, `tin`, `status`, `created`, `updated`) VALUES
(1, 'Duropillo', '', 1234567890, 'duro@gmail.com', '1', 'hii duro', 'vbhnj', 'hjkl', 1, '2021-10-24 14:41:47', '2021-10-24 14:41:47'),
(3, 'Teqnohub', '', 7078058343, 'jeetmehra2323@gmail.com', '3', 'hii', 'vbhnj', 'hjkl', 1, '2021-11-02 11:41:56', '2021-11-02 11:41:56'),
(4, 'Teqno', '', 18077605854, 'jeetmehra2@gmail.com', '2', 'hiihh', 'vbhnj', 'hjkl', 1, '2021-11-02 11:42:33', '2021-11-02 11:42:33');
...
--
-- Table structure for table `gst_treatment`
--

CREATE TABLE `gst_treatment` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `gst_treatment`
--

INSERT INTO `gst_treatment` (`id`, `gst_per`, `status`) VALUES
(1, 5, 1),
(2, 10, 1),
(3, 20, 1),
(4, 50, 1);
...
CREATE TABLE `items` (
  `id` int(11) NOT NULL,
  `type` int(11) NOT NULL COMMENT '1=>product,2=>service',
...
INSERT INTO `items` (`id`, `type`, `name`, `description`, `qty`, `unit`, `tax`, `hsn`, `sku`, `tin`, `status`, `created`) VALUES
(2, 1, 'jitendra mehra', 'Description', 10, 2, 2, 'hsn', 'sku', 'tin', 1, '2021-11-08 13:28:09'),
(3, 2, 'jeeto', 'jjjkkk', 0, 2, 4, 'hsnh', 'skus', 'tint', 1, '2021-11-08 13:31:53');
...
CREATE TABLE `purchase` (
  ...
  `chess_per` int(11) NOT NULL,
  `chess` int(11) NOT NULL,
  `created` datetime NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `purchase` (`id`, `item_id`, `unit_price`, `currency`, `chess_per`, `chess`, `created`) VALUES
(1, 2, 4, 2, 3, 4, '2021-11-08 13:28:09'),
(2, 1, 456, 1, 3, 4, '2021-11-08 13:31:54'),
(3, 3, 45, 1, 3, 4, '2021-11-08 13:46:35');
...
INSERT INTO `sale` (`id`, `item_id`, `unit_price`, `currency`, `chess_per`, `chess`, `created`) VALUES
(2, 2, 1, 1, 1, 2, '2021-11-08 13:28:09'),
(3, 1, 123, 2, 1, 2, '2021-11-08 13:31:54'),
(4, 3, 123456, 2, 1123, 2234, '2021-11-08 13:46:35');
...
--
-- Indexes for table `gst_treatment`
--
ALTER TABLE `gst_treatment`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `gst_treatment`
--
ALTER TABLE `gst_treatment`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
